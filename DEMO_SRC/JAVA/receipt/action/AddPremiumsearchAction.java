...
import gtone.changeminer.receipt.form.AddPremiumsearchForm;
...
/**
 * @struts.action
 *      path="/add_premium_paid_search"
 *      name="addPremiumsearchForm"
 *      scope="request"
 *      validate="false"
 *
 * @struts.action-forward
 *      name="add_premium_paid_search"
 *      path="/add_premium_paid_search.jsp"
 *
 *
 * @struts.action-forward
 *      name="alert"
 *      path="/alert.jsp"   
 */
public  class AddPremiumsearchAction extends AddCyberRecAction
{
		...
		throws Exception
	{
		try
		{
			Logger.debug.println("################ AddPremiumsearchAction Start ####################");
			...
			AddPremiumsearchForm premiumsearchForm = (AddPremiumsearchForm) form;
			...
			AddPremiumsearchManager manager = AddPremiumsearchManager.getInstance();
			...
			Logger.debug.println("################ AddPremiumsearchAction End ####################");

		    if( !bankerr.equals("-1") )
		    {
	           	String msg = message;
	        	String url = "/receipt/add_premium_paid_search.do?policy_apln_no="+policy_apln_no+"&ssn="+ssn+"&policy="+policy+"&bnkyn="+bnkyn;
			...
			return mapping.findForward("add_premium_paid_search");
		    }
