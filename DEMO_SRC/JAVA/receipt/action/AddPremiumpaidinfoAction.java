...
import gtone.changeminer.receipt.form.AddPremiumpaidinfoForm;
import gtone.changeminer.receipt.manager.AddPremiumpaidinfoManager;
...
/**
 * @struts.action
 *      path="/add_premium_paid_info"
 *      name="addPremiumpaidinfoForm"
 *      scope="request"
 *      validate="false"
 *
 * @struts.action-forward
 *      name="add_premium_paid_info"
 *      path="/add_premium_paid_info.jsp"
 *
 * @struts.action-forward
 *      name="alert"
 *      path="/alert.jsp"   
 */
public  class AddPremiumpaidinfoAction extends AddCyberRecAction
{
		...
		throws Exception
	{
		try
		{
			Logger.debug.println("################ AddPremiumpaidinfoAction Start ####################");
			...
			AddPremiumpaidinfoForm premiumpaidinfoForm = (AddPremiumpaidinfoForm) form;
			...
			AddPremiumpaidinfoManager manager = AddPremiumpaidinfoManager.getInstance();
			...
			Logger.debug.println("################ AddPremiumpaidinfoAction End ####################");
			...
			return mapping.findForward("add_premium_paid_info");
		    }
		}
		catch (Exception e)
		{
