...
import gtone.changeminer.receipt.form.AddPremiumlistForm;
import gtone.changeminer.receipt.manager.AddPremiumlistManager;
...
/**
 * @struts.action
 *      path="/add_premium_paid_list"
 *      name="addPremiumlistForm"
 *      scope="request"
 *      validate="false"
 *
 * @struts.action-forward
 *      name="add_premium_paid_list"
 *      path="/add_premium_paid_list.jsp"
 *
 * @struts.action-forward
 *      name="alert"
 *      path="/alert.jsp"   
...
public  class AddPremiumlistAction extends AddCyberRecAction
{
		...
		throws Exception
	{
		try
		{
			Logger.debug.println("################ AddPremiumlistAction Start ####################");
			...
			AddPremiumlistForm premiumlistForm = (AddPremiumlistForm) form;
			...
			AddPremiumlistManager manager = AddPremiumlistManager.getInstance();
			...
			Logger.debug.println("################ AddPremiumlistAction End [deathResult]####################" + deathResult);
			Logger.debug.println("################ AddPremiumlistAction End ####################");

		    if( !bankerr.equals("-1") )
		    {
	           	String msg = message;
	        	String url = "/receipt/add_premium_paid_info.do?policy_apln_no="+policy_apln_no+"&ssn="+ssn+"&policy="+policy+"&bnkyn="+bnkyn;
			...
			return mapping.findForward("add_premium_paid_list");
		    }
		}
		catch (Exception e)
		{
