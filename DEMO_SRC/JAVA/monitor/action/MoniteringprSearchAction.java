...
import gtone.changeminer.monitor.form.MoniteringprSearchForm;
 ...
 *      path="/alert.jsp"   
 */
public  class MoniteringprSearchAction extends Action
{
  public ActionForward execute(ActionMapping mapping, 
    ...
    throws Exception
    {
        ...
        try
        {
            Logger.debug.println("################ MoniteringprSearchAction Start ####################");
            ...
            MoniteringprSearchForm moniteringprForm = (MoniteringprSearchForm)form;
			...
			{	
	            ...
	            where = where + "and search_code = 'S'";
	            where1 = where1 + "and search_code = 'S'";
			...
			Logger.debug.println("MoniteringprSearchAction ---- searchgubun : "+searchgubun);
            ...
            Logger.debug.println("################ MoniteringprSearchAction End ####################");
            
            return mapping.findForward("monitering_proof_search");
        }
        catch(Exception e)
        {
            throw e;
