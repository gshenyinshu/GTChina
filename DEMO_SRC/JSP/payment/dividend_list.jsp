...
<!---->
<jsp:useBean id="dividendlist" 	class="anyframe.data.DataSet" scope="request"/>
...
<input type="hidden" name="returnurl"  value="/payment/dividend_list.do">
...
<%
																int cnt = dividendlist.getCount("divdopt");
																if(cnt == 0)
																{
%>
																<tr align="center"> 
...
<%
																		String divdopt = "";
																		divdopt = dividendlist.getText("divdopt",i).trim();
																		if(divdopt.equals("1"))
																		{
																			divdopt = "현금지급식";
																		}
...
<%
																		String divdate = "";
																		divdate = dividendlist.getText("divdate",i).trim();
																		if(divdate.length() > 7)
																		{
...
%>																	
																	...
																	<td class="ce"><%=dividendlist.getText("ldivyy",i).trim()%></td>
																	<td><%=Util.addComma(dividendlist.getText("totdivd",i).trim())%></td>
																	<td><%=Util.addComma(dividendlist.getText("divthis",i).trim())%></td>
																	<td><%=Util.addComma(dividendlist.getText("tdivint",i).trim())%></td>
																	<td><%=Util.addComma(dividendlist.getText("curint",i).trim())%></td>
																	<td><%=Util.addComma(dividendlist.getText("aftint",i).trim())%></td>
																	<td><%=Util.addComma(dividendlist.getText("balsum",i).trim())%></td>
																</tr>
<%
																		totdivd = totdivd + Integer.parseInt(dividendlist.getText("totdivd",i).trim());//총발생배당액
																		divthis = divthis + Integer.parseInt(dividendlist.getText("divthis",i).trim());//금년도발생액
																		tdivint = tdivint + Integer.parseInt(dividendlist.getText("tdivint",i).trim());//총발생이자
																		curint = curint + Integer.parseInt(dividendlist.getText("curint",i).trim());//예치총액
																		aftint = aftint + Integer.parseInt(dividendlist.getText("aftint",i).trim());//예치이자
																		balsum = balsum + Integer.parseInt(dividendlist.getText("balsum",i).trim());//실효우지급이자
