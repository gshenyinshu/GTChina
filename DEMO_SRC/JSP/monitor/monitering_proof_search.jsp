 ...
 * File        : /monitor/monitering_proof_search.jsp
 * @author     : 김보영
...
<form name="form" method="post"  action="monitering_proof_search.do">
						...
						<table width="100%">
							...
							<tr> 
								<td>
									<table width="100%">
										<tr> 											
                      						<td><img src="/img/common/bu_cir01.gif"> <b>모니터링(증명서화면조회)</b></td>
											<!--
					                        <td align="right">
<%
