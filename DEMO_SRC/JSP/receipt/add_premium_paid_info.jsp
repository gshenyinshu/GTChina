							...
							<tr> 
								<td> <table width="100%">
										<tr> 											
											...
											<td align="right"><a href="/receipt/policy_view.do?modeind=2&srvc_ind=6&searchgubun=S" onFocus="blur()"><img src="/img/common/btn_list.gif" hspace="10" border="0"></a></td>
										</tr>
									</table></td>
							</tr>
							<tr> 
																...
																<tr> 																	
												                                  <td background="/img/edit/subtitle_bg.gif"> 
												                                    <table height="31" class="subtitle">
												                                      <tr> 
												                                        <td><a href="premium_paid_search.do?policy_apln_no=<%=policy_apln_no%>&ssn=<%=ssn%>&policy=<%=policy%>" onFocus="blur()">보험료조회</a></td>
												                                        <th>|</th>
												                                        <td><a href="premium_paid_info.do?policy_apln_no=<%=policy_apln_no%>&ssn=<%=ssn%>&policy=<%=policy%>" onFocus="blur()">계약기본사항</a></td>
...
%>																			
													...
													<tr> 
														<td><table width="100%" class="adm_table" style="margin: 0px; table-layout: fixed;"><col width="40"><col width="60"><col width="75"><col width="75"><col width="75"><col width="75"><col width="80"><col width="60"><col width="60"><col width="60"><col width="">
									                                  <th>회차</th>
									                                  <th>월분</th>
									                                  <th>차기납입일</th>
									                                  <th>납입/입금일</th>
									                                  ...
									                                  <th>납주</th>
									                                  <th>경로</th>
									                                </tr></table><div style="overflow: auto; width: 100%; height: 200px;"><table width="100%" class="adm_table" style="table-layout: fixed;"><col width="40"><col width="60"><col width="75"><col width="75"><col width="75"><col width="75"><col width="80"><col width="60"><col width="60"><col width="60"><col width="">
<%
