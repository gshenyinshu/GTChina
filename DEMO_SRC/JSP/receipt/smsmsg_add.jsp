...
<input type="hidden" name="smsgubun">
<input type="hidden" name="cpflag">
...
<center>
    <table width="600">
		...
		<tr> 
			<td><img src="/img/common/bu_cir01.gif"> <b>SMS 추가</b></td>
		</tr>
		<tr> 
			<td height="7"></td>
		</tr>
...
%>
					...
					<tr> 
						<td>회신전화</td>
						<td><input type="text" name="call_back"  value="15883374"   size="60" style="background-color:white; border-width:0; text-align:center;border-color:black; border-style:solid;" readonly ></td>
					</tr>
					<tr> 
						<td>발송메세지</td>
