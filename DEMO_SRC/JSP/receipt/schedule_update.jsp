...
<form name='scheduleForm'>
                ...
                <tr>
                  <td><table width=100% class=mytable01>
                      ...
                      <tr> 
                        ...
                        <td class=my12><textarea name="contents" style="width:100%; height:200px;" class=box></textarea>
    ...
    <tr> 
      <td class=popbtn2><img src="/img/common/mypage/my_btn_close.gif" hspace="20" vspace="10" 
                            onClick='window.close()' style='cursor;hand;'>
                        <img src="/img/common/mypage/my_btn_write04.gif" vspace="10"
