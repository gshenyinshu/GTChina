...
<%@ page import="anyframe.data.DataSet, anyframe.log.*,anyframe.util.*"%>
...
<form name="form" method="post"  action="pay_proc_report.do">
								...
								<td><table width="100%" class="adm_table">
					                      ...
					                      <tr class="adm11"> 
					                        ...
					                        <td> <select name="srvc_cd"  size="1" style="width:120px;" >
					                            ...
					                            <option value="1"  <% if(srvc_cd.equals("1")){ %> selected <% } %>>약관대출</option>
					                            <option value="4"  <% if(srvc_cd.equals("4")){ %> selected <% } %>>배당금</option>
					                            <option value="5"  <% if(srvc_cd.equals("5")){ %> selected <% } %>>휴면보험금</option>
					                            <option value="7"  <% if(srvc_cd.equals("7")){ %> selected <% } %>>배당금상계</option>
...
<%
										...
										{
											payor_ssn = payor_ssn.substring(0,6)+"-"+payor_ssn.substring(6);
										}
%>						                          
						                          <td><%=payor_ssn%></td>
						                          <td><div align="right"><%=Util.addComma(trans.removeZero(policyview.getText("pay_amt",i)))%></div></td>
...
%>                      					
									<table width="400" class="adm_table" align="center">
						                        <tr> 
						                          ...
						                          <td><div align="right"><%=Util.addComma(sumCount.getText("pay_amt"))%>원</div></td>
						                        </tr>
									</table>						                        	
<%
									}	
